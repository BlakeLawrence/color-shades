# Random Colour Shades


###  How It Works 🛠️
Click on the button under the colour to change the shade of that color.
...
## Mission
This was a very simple Vanilla JavaScript app build in order to refresh my memory on query selectors etc. We ended the bootcamp on React and so I wanted to spend a couple hours playing with basic Vanilla JS again.


## Try it out on Netlify 🖥️
[Click here](https://random-color-shades.netlify.app) 
